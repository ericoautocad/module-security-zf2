 ...
 */
class Usuario extends \Security\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Security\\Entity\\Usuario' . "\0" . 'id', '' . "\0" . 'Security\\Entity\\Usuario' . "\0" . 'login', '' . "\0" . 'Security\\Entity\\Usuario' . "\0" . 'senha', '' . "\0" . 'Security\\Entity\\Usuario' . "\0" . 'salt', '' . "\0" . 'Security\\Entity\\Usuario' . "\0" . 'ativo', '' . "\0" . 'Security\\Entity\\Usuario' . "\0" . 'grupo');
        }
    ...
    public function generateSaltSecurity($login = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'generateSaltSecurity', array($login));

        return parent::generateSaltSecurity($login);
    }
